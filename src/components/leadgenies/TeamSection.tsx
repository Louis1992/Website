        ...
        >
          ...
          {t.members.length > 1 && (
            <>
              <button
                onClick={prevMember}
                aria-label={lang === 'de' ? 'Vorheriges Teammitglied' : 'Previous team member'}
                style={{
                  position: 'absolute',
              ...
              <button
                onClick={nextMember}
                aria-label={lang === 'de' ? 'Nächstes Teammitglied' : 'Next team member'}
                style={{
                  position: 'absolute',
          ...
          >
            {t.members.map((_, index) => (
              <button
                ...
                aria-label={lang === 'de' ? `Teammitglied ${index + 1} anzeigen` : `Show team member ${index + 1}`}
                style={{
